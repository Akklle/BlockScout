...
async function getTransaction(
    ...
    if (fetchResult.status != 200) {
        ...
        const result: Transaction = await fetchResult.json()
...
async function getTokens(
    ...
    const url = `${baseUrl}/transactions/${number}/tokens`
    const result: Array<Token> = await (await fetch(url)).json()
    setTokens(result)
}
                    ...
                    <TabPanel>
                        <div className={styles.details}>
                            ...
                            <div className={styles.infoRow}>
                                ...
                                <Status theme={transaction.result}>
                                    {processedStringFromApi(transaction.result)}
                                </Status>
                            </div>
                            <div className={styles.infoRow}>
                                <img
